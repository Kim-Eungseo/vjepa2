...
def gpu_batch_replay_all(
    ...
    # Add an overall progress bar over episodes
    for ep_idx in tqdm(episode_indices, desc=f"Overall Episode Progress"):
...
def bg_replay_worker(args_tuple):
    ...
    for cid in config_ids:
        config = all_configs["background"][cid].copy()
        config["_res"] = resolution
